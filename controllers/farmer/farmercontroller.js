...
exports.getVegetableList = (req, res, next) => {
    ...
    exports.getTransactionDetails = (req,res,next) => {
        ...
        let sql2 = "SELECT p.advance_date_time,p.min_advance,p.payment_status,u.first_name,u.last_name FROM paid_orders p,user u WHERE p.farmer_id = ? AND p.buyer_id = u.id"; 
        let values = [id]
