...
exports.getTransactionDetails = (req,res,next) => {
    ...
    let sql1 = "SELECT id FROM user WHERE email=?"
        ...
        let sql2 = "SELECT p.advance_date_time,p.payment_status,p.min_advance,p.remaining_payment,u.first_name,u.last_name FROM paid_orders p,user u WHERE p.buyer_id = ? AND p.farmer_id=u.id" 
